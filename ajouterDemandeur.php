<?php
    ...
    if(isset($_POST['valide'])){
        if(!empty($_POST['matricule']) && !empty($_POST['nomcomplet'])){
            ...
            //$email=htmlspecialchars($_POST['email']);
            $insertUser=$db->prepare('insert into demandeur(matricule,nomcomplet,email) value(?,?,?)');
            $insertUser->execute(array($matricule,$nomcomplet,$email));
      ...
      <div class="corps-formulaire">
        <div class="gauche">
          <div class="groupe">
            ...
            <input style="width:400px;" type="text" autocomplete="off" placeholder="Entrer le nom complet du demandeur" name="nomcomplet"/>
            <i class="fas fa-user"></i>
          </div>
          <div class="groupe">
            <label>Matricule :</label>
            <input style="width:400px;" type="text" autocomplete="off" placeholder="Entrer son matricule" name="matricule"/>
            <i class="fas fa-mobile"></i>
          </div>
          <div class="groupe">
            <label>Email :</label>
            <input style="width:400px;" type="text" autocomplete="off" placeholder="Entrer email pour alerte des DA" name="email"/>
            <i class="fas fa-mobile"></i>
          </div>
        </div>
        ...
        <div class="col-md-8 align-items-center">
           <?php if($mess == "error"){ ?> <h4 style="color:red; margin-buttom:50px;" id="rejet">Erreur remplir tous les champs svp</h4><?php } ?>
            <div class="d-flex gap-2 pt-4">
              <a href="listeDemandeur.php"><input class="btn btn-danger  w-lg" name="" value="Annuler"></a>
