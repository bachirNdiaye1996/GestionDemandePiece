...
//Pour inserer une DA avec mail de notification 
    ...
    $messageD = "
        ...
        <body>
            <div id='email-wrap' style='background: #33ECFF;color: #FFF; border-radius: 10px;'>
                ...
                <h4 align='center'>Voici la liste des piéces qui sont toujours en attente de livraison ( Nombres : $NbPieceEnAttente  ).</h4>
                </p>
                <br>
                ...
                <br>
                <br>
                <h4 align='center'>Voici la liste des piéces qui sont livrées partiellement ( Nombres : $NbPieceEnPartielle  ).</h4>
                </p>
                <br>
                <table style='border-collapse: separate;  margin-bottom: 50px; border: 1px solid white; border-spacing : 7px;  margin-left: auto; margin-right: auto;'>
                    <thead>
	...
	envoie_mail('Kemba Cisse','kcisse@metalafrique.com','Rapport de la gestion des demandes de pièces',$messageD);
    envoie_mail('Hassan Khachab','achat-pieces@metalafrique.com','Rapport de la gestion des demandes de pièces',$messageD);
	envoie_mail('Mohamed Bennani','mbennani@metalafrique.com','Rapport de la gestion des demandes de pièces',$messageD);
