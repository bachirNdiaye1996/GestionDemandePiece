                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr class="text-start">
                                                                                        ...
                                                                                        <?php 
                                                                                            ...
                                                                                            <a href="javascript:void(0);" id="approuverCommande" class="btn btn-success"><ion-icon name="arrow-undo-outline"></ion-icon>Accepter</a>
                                                                                            <a href="javascript:void(0);" id="rejeterCommande" class="btn btn-danger "><ion-icon name="arrow-undo-outline"></ion-icon>Rejeter</a>
                                                                                            <script>
                                                                                                    $(document).ready( function(){
                                                                                                        $('#approuverCommande').click(function(e) {
                                                                                                            ...
                                                                                                            confirmButtonText: "ACCEPTER LA COMMANDE",
                                                                                                            }).then((result) => {
                                                                                                                if (result.isConfirmed) {                                                                                                                  
                                                                                                                    $.ajax({
                                                                                                                            type: "POST",
                                                                                                                            url: 'deleteAdmin.php?idr='+idr+'&quantites='+quantites+'&livraisonPart='+livraisonPart,
                                                                                                                            //data: str,
                                                                                            ...
                                                                                            <script>
                                                                                                    $(document).ready( function(){
                                                                                                        $('#rejeterCommande').click(function(e) {
