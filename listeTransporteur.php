<?php
    ...
    // On détermine le nombre total d'articles
    $sql = 'SELECT COUNT(*) AS nb_utilisateur FROM `transporteur`;';
    ...
    $sql = 'SELECT * FROM `transporteur` ORDER BY `id` DESC LIMIT :premier, :parpage;';

        // On détermine le nombre total d'articles
        $sql1 = 'SELECT COUNT(*) AS nb_utilisateur FROM `transporteur`;';
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table table-nowrap align-middle">
                                                                                <thead class="table-light">
                                                                                    <tr>                                                                                       
                                                                                        ...
                                                                                        <th scope="col" class="fw-bold text-start">Matricule Voiture<button tabindex="-1" aria-label="Sort column ascending" title="Sort column ascending" class="gridjs-sort gridjs-sort-neutral"></button></th>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr class="text-start">
                                                                                        ...
                                                                                        <td>
                                                                                            <a href="<?php echo "deleteTransporteur.php?id=$article[id]"?>" data-bs-url="images/test.pdf" data-bs-placement="top" title="Supprimer" class="px-2 text-danger" data-bs-original-title="Supprimer" aria-label="Supprimer"><i class="bx bx-trash-alt font-size-18"></i></a>
                                                                                        </td> 
                                                                                    </tr>
                                                                                    <?php
                                                                                        }
                                                                            ...
                                                                            <div class="col-md-8 align-items-center">
                                                                                <div class="d-flex gap-2 pt-4">
                                                                                    <a href="ajouterTransporteur.php" class="btn btn-success  w-lg bouton"><i class="bx bx-plus me-1"></i> Ajouter transporteur</a>
