                                    ...
                                    <ul class="nav nav-pills nav-justified card-header-pills" role="tablist">  
                                        <li class="nav-item">
                                            <a class="nav-link w-50 p-3 active" data-bs-toggle="tab" href="detail-agent.html#termine" role="tab">
                                                <span class="fw-bold font-size-15">Gestion des utilisateurs</span> 
                                            </a>
                                        </li>                              
                                    </ul>
                                </div>
                                                                            ...
                                                                            <table class="table table-nowrap align-middle">
                                                                                <thead class="table-light">
                                                                                    <tr>                                                                                       
                                                                                        ...
                                                                                        <th scope="col" class="fw-bold text-start">Niveau d'accés<button tabindex="-1" aria-label="Sort column ascending" title="Sort column ascending" class="gridjs-sort gridjs-sort-neutral"></button></th>
