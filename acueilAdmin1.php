            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-end pt-0">
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="ajoutercompte.php"><i class="mdi mdi-cog-outline text-muted font-size-16 align-middle me-2"></i> <span class="align-middle me-3">Ajouter utilisateur</span></a>
        ...
        <div class="page-content">
            <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-pills nav-justified card-header-pills" role="tablist">                               
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="detail-agent.html#encours" role="tab">
                                                <span class="fw-bold font-size-15">Commandes en cours</span> 
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="detail-agent.html#termine" role="tab">
                                                <span class="fw-bold font-size-15">Commandes terminés</span> 
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="detail-agent.html#liste" role="tab">
                                                <span class="fw-bold font-size-15">Liste des Commandes</span> 
                                            </a>
                                        </li>   
                                    </ul>
                                </div>
                ...
                <div class="tab-content">
                                                                    ...
                                                                    <div class="accordion-body text-muted">
                                                                        <div class="table-responsive">
                                                                            <table class="table table-nowrap align-middle">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr class="text-start">
                                                                                        ...
                                                                                        <td><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#fileModal" data-bs-url="images/test.pdf" data-bs-placement="top" title="Afficher" class="px-2 text-primary" data-bs-original-title="Modifier" aria-label="Modifier"><i class="bx bx-pencil font-size-18"></i></a>
                                                                                        <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#suppression-btn" data-bs-url="images/test.pdf" data-bs-placement="top" title="Supprimer" class="px-2 text-danger" data-bs-original-title="Supprimer" aria-label="Supprimer"><i class="bx bx-trash-alt font-size-18"></i></a>
                                                                            ...
                                                                            <div class="col-md-8 align-items-center">
                                                                                ...
                                                                                <a href="#" data-bs-toggle="modal" data-bs-target=".add-new" class="btn btn-success  w-lg bouton"><i class="bx bx-plus me-1"></i> Ajouter Commande</a>
                                                                                </div>
                                                                            </div>
                                    ...
                                    <!-- end message -->
                                    <div class="tab-pane" id="termine" role="tabpanel">
                                        <div class="card">
                                           <div class="card-body">
                                             <div class="accordion accordion-flush" id="accordionFlushExample">
                                                            <div class="accordion-item">
                                                                ...
                                                                <div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne"
                                                                    ...
                                                                    <div class="accordion-body text-muted">
                                                                        <div class="table-responsive">
                                                                            ...
                                                                            <div class="col-md-8 align-items-center">
                                                                                <div class="d-flex gap-2 pt-4">
                                                                                <a href="#" data-bs-toggle="modal" data-bs-target=".add-new" class="btn btn-success  w-lg bouton"><i class="bx bx-plus me-1"></i> Ajouter</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row g-0 align-items-center pb-4">
                                                                                <div class="col-sm-12">
                                    ...
                                    <div class="tab-pane" id="liste" role="tabpanel">
                                        <div class="card">
                                        <div class="card-body">
