<?php
    ...
    if(isset($_POST['valideLivraison'])){
        if(!empty($_POST['livraison'])){
            ...
            $req ="UPDATE articles SET status=?, livraisonPart=?, actifmang=1, userlivrer=? WHERE id=$id;"; 
            //$db->query($req); 
    ...
    if(isset($_GET['id']) && $_SESSION['niveau']=='kemc'){
        ...
        //-------------------
        $sql = "SELECT * FROM `articles` where `actif`= 1 and `actifkemb`= 0 and `idda`= '$id' and `quantites`>=0 ORDER BY `id` DESC LIMIT :premier, :parpage;";
                                                                                            ...
                                                                                            <div class="modal-content">
                                                                                                ...
                                                                                                <div class="modal-body">
                                                                                                    <form action="#" method="POST">
                                                                                                        ...
                                                                                                        <div class="row mt-2">
                                                                                                            <div class="col-md-12 text-end">
                                                                                                                <?php if($mess == "error"){ ?> <h4 style="color:red; margin-buttom:50px;" id="rejet2">Erreur remplir tous les champs svp</h4><?php } ?>
                                                                                                                <div class="col-md-8 align-items-center col-md-12 text-end">
                                                                                                                    <div class="d-flex gap-2 pt-4">                           
