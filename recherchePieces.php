...
if(isset($_POST['rechercheDA'])){
    if($_POST['typeChoix'] == "Designation"){
        $choix = $_POST['valRechercheDA'];

        //echo $choix;

        $recupeUser=$db->prepare('select * from articles where designations=?');
        $recupeUser->execute(array($choix));
            
        //print_r($recupeUser);
        if($recupeUser->rowCount() > 0){
            // On definie le nombre de DA
        $sqlda = "SELECT idda, COUNT(*) AS nb_articles FROM `articles` where `designations`=? GROUP BY idda;";
        // On prépare la requête
        $queryda = $db->prepare($sqlda);
    
        // On exécute
        $queryda->execute(array($choix));
        ...
        //$sql = "SELECT * FROM `articles` where `actif`=1 and `designations`=? ORDER BY `id`  DESC LIMIT :premier, :parpage;";
            
        $sql = "SELECT * FROM `articles` where `designations`=? GROUP BY idda;";
        ...
        $articlesDA = $query->fetchAll(PDO::FETCH_ASSOC);

        foreach($articlesDA as $article){
            $sql = "SELECT * FROM `da` where `actif`=1 and `id`=?;";
            ...
            // On exécute
            $query->execute(array($article['idda']));
        
            // On récupère les valeurs dans un tableau associatif
            array_push($articles, $query->fetch()); 
        }
    

    
        }else{$messRech = false;}
    }elseif($_POST['typeChoix'] == "DA" ){
        $choix = htmlspecialchars($_POST['valRechercheDA']);
        ...
        if($recupeUser->rowCount() > 0){
            // On definie le nombre de DA
        $sqlda = "SELECT COUNT(*) AS nb_articles FROM `da` where `actif`=1 and `id`=$choix;";
        // On prépare la requête
        $queryda = $db->prepare($sqlda);
        ...
        $sql = "SELECT * FROM `da` where `actif`=1 and `id`=$choix ORDER BY `id`  DESC LIMIT :premier, :parpage;";
        ...
        //------------DA a approvisionner
        $sql6 = "SELECT COUNT(*) AS nb_articles FROM `da` where `actif`= 1 and `id`=$choix and `actifmang`=1 and `actifkem`=0;";
        ...
        $sql = "SELECT COUNT(*) AS nb_articles FROM `articles` where `actif`= 1 and `id`=$choix and `actifmang`=1;";
        ...
        $sql5 = "SELECT * FROM `da` where `actif`=1 and `id`=$choix and `actifmang`=1  ORDER BY `id`  DESC LIMIT :premier, :parpage;";
...
<script>
    ...
    $( function() {
        var availableTags = <?php echo json_encode($_SESSION['ProduitDesign1']); ?>;
        console.log(availableTags);
        $( ".valRechercheDA" ).autocomplete({
        minLength:3,
...
<header id="page-topbar" class="">
    ...
    <div class="row header-item user text-start d-flex align-items-center w-75 p-3">                  
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Recherche (DA)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Nombres trouvés : <?php echo $nbda;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div>
        ...
        <?php 
            if($_SESSION['niveau']=='kemc' || $_SESSION['niveau']=='mang' || $_SESSION['niveau']=='admin'){
        ?>    
                <form action="#" method="POST" class="row header-item user text-start d-flex align-items-center w-75 p-3">
                    <div class="input-group mb-3">
                    <input class="btn btn-success  w-lg bouton" name="rechercheDA" type="submit" value="Rechercher">
                    <select class="form-select w-25" name="typeChoix" id="inputGroupSelect03" aria-label="Example select with button addon">
                        <option>Choisir type</option>
                        <option value="DA">DA</option>
                        <option selected value="Designation">Désignations</option>
                    </select>
                    <input class="valRechercheDA form-control w-50" type="text" value="" name="valRechercheDA" id="valDA example-date-input" placeholder="DA ou désignation...">
                    </div>
                </form>
            <!-- Tab content -->
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table class="table table-nowrap align-middle">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                ?>
                                                                                    <tr>
                                                                                        <td style="font-size:30px;color:red">Il n'y a pas de résultat à cette recherche!</td>
                                                                                    </tr>
                                                                                <?php 
                                                                                    }
                                                                                ?>
                                                                                <?php
                                                                                    ...
                                                                                    foreach($articles as $article){
                                                                                        if($article['actifda']==0 && $_SESSION['niveau']=='mang'){
                                                                                        $i+=1;
                                                                                        //if($article['status'] == 'termine'){
                                                                                ?>   
                                                                                    
                                                                                        <tr>
                                                                                            <td style="font-size:30px;color:red">Cette DA n'est pas encore approuvée!</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td><a href="acueilAdmin.php" class="btn btn-danger  w-lg "><ion-icon name="arrow-undo-outline"></ion-icon>Retour</a></td>
                                                                                        </tr>
                                                                                    <?php 
                                                                                        return 0;
                                                                                        }
                                                                                    ?>                                                                         
                                                                                <tr class="text-start">
                                                                                    <td class=".bg-light"><a href="<?php echo "acueilAdmin1.php?id=$article[id]&recherche=true"?>" class="btn  w-lg bouton" data-toggle="tooltip" data-placement="top" title="Ouvrir la DA"><i class="bx me-2"></i><?php echo "DA00".$article['id']; ?></a></td>
                                                                                    <td><?= $article['user'] ?></td>
                                                                                    <td>
                                                                                        <span class="<?php 
                            ...
                            <div class="modal-body">
                                <form action="#" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="form-check"> 
                                            <input class="form-check-input" type="checkbox" style="margin-left: 10px; margin-right: 50px; width: 35px; height: 35px" name="email1" value="" id="flexCheckChecked">
                                            <p class="form-check-label text-start" style="font-size: 25px;" for="flexCheckDefault">
                                                Ghaleb JABER 1
                                            </p>
                                        </div> 
                                        ...
                                        <div class="form-check"> 
                                            <input class="form-check-input" type="checkbox" style="margin-left: 10px; margin-right: 50px; width: 35px; height: 35px" name="email9" value="mouhamadoulbachirndiaye@esp.sn" id="flexCheckChecked">
                                            <p class="form-check-label text-start" style="font-size: 25px;" for="flexCheckDefault">
                                                Bennan
                                            </p>
                                        </div>
